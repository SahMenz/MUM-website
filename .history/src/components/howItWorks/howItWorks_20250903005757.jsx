        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div style={{maxWidth:"589px"}}>
            <div className="d-flex align-items-center justify-content-between">
              ...
              <div >
                <div className="fs-19 fw-400 d-flex align-items-center justify-content-center" style={{borderRadius:"100%", width:"40px", height:"40px", backgroundColor:"#FA0808"}}>1</div>
                <div style={{}}></div>
              </div>
