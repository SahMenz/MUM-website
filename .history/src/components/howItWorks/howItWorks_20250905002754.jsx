...
function HowItWorks() {
  ...
  const scrollLeft = () => {
    if (scrollContainerRef.current) {
      scrollContainerRef.current.scrollBy({
        left: -503, // Scrolls left by the width of one testimonial card + gap
        behavior: "smooth",
      });
    }
  };
  ...
  const scrollRight = () => {
    if (scrollContainerRef.current) {
      scrollContainerRef.current.scrollBy({
        left: 503, // Scrolls right by the width of one testimonial card + gap
        behavior: "smooth",
      });
    }
  };
          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="gap-3 d-flex ">
              <div
                ...
                onClick={scrollLeft} // Added click handler
              >
                <BsArrowLeft size={25} />
              </div>
              <div
                ...
                onClick={scrollRight} // Added click handler
              >
