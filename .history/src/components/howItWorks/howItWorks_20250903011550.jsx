      ...
      <div>
        <div className="d-flex align-items-center justify-content-between flex-column ">
          ...
          <div style={{maxWidth:"589px", width:"100%"}}>
            <div className="gap-5 w-100 d-flex justify-content-between">
              ...
              <div className="d-flex flex-column align-items-center ">
                ...
                <div style={{width:"0px", marginTop:"12px" , height:"104px",border:"1px solid #FA0808", linearGradient:"90deg, #FA0808 52.11%, #FFFBFB 100%"}}></div>
              </div>
