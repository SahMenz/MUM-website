        ...
        <div className="d-flex align-items-center justify-content-between flex-column gap-4 flex-md-row">
          ...
          <div style={{maxWidth:"589px", width:"100%"}}>
            ...
            <div className="gap-4 w-100 d-flex justify-content-between mt-3">
              ...
              <div className="d-flex flex-column align-items-center ">
                <div className="fs-19 fw-400 d-flex align-items-center justify-content-center txt-f5" style={{borderRadius:"100%", width:"40px", height:"40px", backgroundColor:"#737373"}}>2</div>
                <div style={{width:"0px", marginTop:"12px", height:"90px",border:"1px solid #737373", }}></div>
              </div>
              <div style={{maxWidth:"425px"}}>
                <div className="fs-23 fw-500">See Real Photos</div>
                <div className="fs-16 fw-400 mt-4">Recognize the place before you arrive — no more second-guessing or awkward wrong turns.</div>
              </div>
            </div>
            ...
            <div className="gap-4 w-100 d-flex justify-content-between mt-3">
              <div className="fs-19 fw-400 txt-73">Step</div>
              <div className="d-flex flex-column align-items-center ">
                <div className="fs-19 fw-400 d-flex align-items-center justify-content-center txt-f5" style={{borderRadius:"100%", width:"40px", height:"40px", backgroundColor:"#737373"}}>3</div>
                <div style={{width:"0px", marginTop:"12px", height:"90px",border:"1px solid #737373", }}></div>
              </div>
              <div style={{maxWidth:"425px"}}>
                <div className="fs-23 fw-500">Follow Directions</div>
                <div className="fs-16 fw-400 mt-4">Step-by-step to your destination — with clear directions that keep you on track.</div>
              </div>
            </div>
            ...
            <div className="gap-4 w-100 d-flex justify-content-between mt-3">
              ...
              <div style={{maxWidth:"425px"}}>
                ...
                <div className="fs-16 fw-400 mt-4">Reach every destination with ease — know the way before you even leave, Or ping your friends to meet up.</div>
              </div>
            </div>
          </div>
        </div>
