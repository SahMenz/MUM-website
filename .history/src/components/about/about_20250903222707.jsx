  ...
  return (
    <div className="spacing-50 mt-4 d-flex flex-column align-items-center">
      ...
      <div className="d-flex gap-3 gap-lg-5 mt-5">
        <div>
          <img src={forFreshers} style={{ width: "100%", minWidth:"150px" }} />
        </div>
        <div className="d-flex gap-3 gap-lg-5 flex-column">
          <div>
            <img src={forReturningStudent} style={{ width: "100%", minWidth:"150px" }} />
          </div>
          <div>
            <img src={forVisitors} style={{ width: "100%", minWidth:"1500px" }} />
          </div>
        </div>
      </div>
      <div className="d-flex justify-content-between col-10 flex-column flex-lg-row col-lg-12 mt-5 align-items-center gap-4">
