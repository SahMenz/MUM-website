...
function About() {
  return (
    <div className="spacing-50 mt-4 d-flex flex-column align-items-center">
      ...
      <div className="d-flex justify-content-between col-10 mt-5 align-items-center gap-4">
        <div><img src={yourCampus} style={{width:"100%"}}/></div>
        <div className="text-start" style={{maxWidth:"520px"}}>
          ...
          >
            <p className="mb-0 fw-500">Get started fo rfree</p>
          </button>
        </div>
      </div>
    </div>
