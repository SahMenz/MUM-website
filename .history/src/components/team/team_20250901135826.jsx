    ...
    <div className="spacing-50 mt-4">
      ...
      <div>
        <div className="d-flex align-items-center justify-content-between">
          <img src={img1} />{" "}
          <div>
            <div className="fs-53 fw-600">The Team 
Behind the Technology.</div> <div className="fs-19 fw-400">We’re Control Genesis — students and creators building tools to make campus life easier. We face the same struggles, so we set out to solve them.</div>{" "}
          </div>{" "}
          <img src={img2} />
        </div>
        <div></div>
