...
function Team() {
  return (
    <div className="spacing-50 mt-4">
      ...
      <div className="mt-5">
        <div className="d-flex align-items-center gap-5 justify-content-center justify-content-lg-between flex-wrap">
          <img src={img1} />{" "}
          <div className="text-center " style={{maxWidth:"661px", minWidth:"400px"}}>
