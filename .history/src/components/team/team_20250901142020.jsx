...
function Team() {
  return (
    <div className="spacing-50 mt-4">
      ...
      <div className="mt-5">
        <div className="d-flex align-items-center gap-5 justify-content-center flex-column flex-lg-row justify-content-lg-between" style={{top:"50px", position:"relative"}}>
          <img src={img1} />
          <div className="text-center " style={{maxWidth:"661px", minWidth:"300px", top:"50px", position:"relative" }}>
        ...
        <div className="d-flex mt-5 align-items-center gap-5 justify-content-center flex-column flex-md-row justify-content-md-between">
          <img src={img3} />
