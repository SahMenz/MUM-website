  ...
  return (
    <div className="spacing-50 my-5">
      ...
      <div className="mt-5">
        ...
        <div className="d-flex mt-5 align-items-center gap-5 justify-content-center flex-column flex-md-row justify-content-md-between"style={{top:"100px", position:"relative"}}>
          <img src={img3} />
