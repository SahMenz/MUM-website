  ...
  return (
    <div className="spacing-50 mt-4">
        <div className="open&distance col-12">
            <div className="txt-f5 d-flex flex-column p-3 distance" style={{maxWidth:"869px", borderRadius:"16px", backgroundColor:"#73737333"}}>
                ...
                <div className="bg-ff" style={{borderRadius:"60px", padding:"10px", alignSelf:"end", minWidth:"200px"}}>
