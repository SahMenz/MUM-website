  ...
  return (
    <div className="spacing-50 mt-4">
        <div className="distance col-12">
            <div className="txt-f5 d-flex flex-column p-3" style={{maxWidth:"869px", borderRadius:"16px", backgroundColor:"#73737333"}}>
                ...
                <div className="bg-ff d-flex align-items-center" style={{borderRadius:"60px", padding:"10px", alignSelf:"end", minWidth:"80px"}}>
                    <input placeholder="Your email address" style={{border:"none", marginLeft:"20px"}}/>
