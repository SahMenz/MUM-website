...
function Footer() {
  return (
    <div className="mt-5 spacing-50 FooterWavyBackground  d-flex align-items-center  flex-column bg-fa txt-f5">
      <div className="d-flex col-12 justify-content-between flex-wrap">
        ...
        <div className="d-flex gap-4 flex-column">
            <div className="fs-19 fw-600">Quick links</div>
      ...
      <div className="fs-19 fw-800 mt-5">Built by Students, for Students</div>
    </div>
  );
}
