    ...
    <div className="mt-5 spacing-50 FooterWavyBackground gap-5  d-flex align-items-center  flex-column bg-fa txt-f5">
      <div className="d-flex col-12 gap-5 justify-content-between flex-column flex-wrap flex-md-row">
        ...
        <div className="d-flex gap-4 flex-column">
          ...
          <div onClick={onAboutClick} className="fs-16 fw-500">Home</div>
          <div onClick={onAboutClick} className="fs-16 fw-500">About</div>
          <div onClick={onFeaturesClick} className="fs-16 fw-500">Features</div>
          <div onClick={onHowItWorkClick} className="fs-16 fw-500">How it works</div>
          <div onClick={onFaqsClick} className="fs-16 fw-500">FAQs</div>
        </div>
        <div>
          <div className="d-flex gap-4 flex-column">
