  ...
  return (
    <div className="mt-5 txt-00 pt-5">
      ...
      <div>
        ...
        >
          <div className="d-flex align-items-center justify-content-between">
            <div className="fs-23 fw-500">Does it work on Andriod?</div>
            {open1 && (
              <div>
                <CustomSvg name="minus" />
              </div>
          ...
          {open1 && <div className="mt-4 fs-19 fw-400 txt-00">Yes — full launch is for both iOS and Android. We’re just testing iOS first.</div>}
        </div>
        ...
        >
          ...
          {open2 && <div className="mt-4 fs-19 fw-400 txt-00">No. Location sharing is fully permission-based.
</div>}
        </div>
        ...
        >
          ...
          {open3 && <div className="mt-4 fs-19 fw-400 txt-00">Yes, but we’re working on ways to save key locations for offline use.
</div>}
        </div>
