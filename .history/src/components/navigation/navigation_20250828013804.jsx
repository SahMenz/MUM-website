...
function Navigation({
  ...
  return (
    <div className="spacing-50 bg-ff4 d-flex align-items-center justify-content-between">
      ...
      >
        ...
        <Offcanvas.Body>
          <div
            ...
            className="bg-fa txt-ff pt-4 d-flex flex-column d-lg-flex justify-content-center align-items-center"
          >
            <div
            ...
            >
              <NavLink
                to="/"
                style={({ isActive }) => ({
                  color: isActive ? "#737373" : "#737373",
                })}
                className="hovering txt-16 lh-19 fw-600 mb-2 text-decoration-none txt-f3"
                end
              >
                Home
              </NavLink>
