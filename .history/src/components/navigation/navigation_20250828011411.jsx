  ...
  return (
    <div className="spacing-50 bg-ff4 ">
      <div className="d-flex justify-content-between align-items-center">
        ...
        <button className="d-none d-lg-block px-4 py-2 bg-fa txt-ff" style={{borderRadius:"30px"}}>contact us</button>
      </div>
      {/* </div> */}
      <div
        onClick={handleShow}
      ...
      >
        ...
        <button className=" px-4 py-2 bg-fa txt-ff" style={{borderRadius:"30px"}}>contact us</button>
            </div>
          </div>
        </Offcanvas.Body>
      </Offcanvas>
