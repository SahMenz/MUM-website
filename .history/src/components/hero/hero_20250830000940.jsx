...
function Hero() {
  return (
    <div className="bg-ff4  d-flex align-items-center flex-column justify-content-center text-center">
      ...
      <div className="d-flex flex-column align-items-center flex-lg-row wavyBackground justify-content-center pt-3 mt-5 gap-3">
        <div
        ...
        <div className="d-flex flex-column gap-5">
          {/* <div> */}
          <div
            className="text-start bg-ffb p-4 ms-4"
