  ...
  return (
    <div className="bg-ff4  d-flex align-items-center flex-column justify-content-center text-center">
      ...
      <div className="d-flex flex-column flex-lg-row">
        <div>
          <div><img src={unCover}/></div>
          <div className="fs-16 fw-500">Uncover Hidden Campus Spots</div>
          <div className="fs-13 fw-400">Restrooms, food joints, study nooks, and hangout corners — discover the places only students talk about. Explore your campus like never before.</div>
        </div>
        <img src={mumOnPhone}/>
        <div></div>
      </div>
