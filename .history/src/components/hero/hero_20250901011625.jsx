...
function Hero() {
  return (
    <div className="bg-ff4  d-flex align-items-center flex-column justify-content-center text-center">
      ...
      <div className="d-flex gap-4 mt-4 flex-column flex-md-row spacing-50-adjusted">
        <button
      ...
      <div className="d-flex flex-column align-items-center flex-xl-row wavyBackground justify-content-center pt-3 mt-5 gap-4">
        <div
          className="text-start bg-ffb p-4"
          style={{ maxWidth: "284px",minWidth:"264px", borderRadius: "16px" }}
        >
          <div>
            <img src={unCover} />
          </div>
        ...
        <img src={mumOnPhone} style={{width:"100%", maxWidth:"427px"}}/>
        <div className="d-flex flex-column gap-5">
          {/* <div> */}
          <div
            className="text-start bg-ffb p-4 ms-5"
            style={{ maxWidth: "284px",minWidth:"248px", borderRadius: "16px" }}
          >
            <div>
              <img src={navigate} />
            </div>
          ...
          <div className="d-none d-lg-block" style={{height:"4vh", maxHeight:"200px"}}>

          </div>
          <div
            className="text-start bg-ffb p-4"
            style={{ maxWidth: "284px",minWidth:"250px", borderRadius: "16px" }}
          >
            <div>
              <img src={connect} />
            </div>
