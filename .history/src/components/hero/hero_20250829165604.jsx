...
function Hero() {
  return (
    <div className='bg-ff4  d-flex align-items-center flex-column justify-content-center text-center'>
      ...
      <div className='spacing-50 fw-400 fs-19 col-10 col-md-8 mt-3'>From hidden restrooms and food joints to that one POS that actually works — our campus navigation app helps you see what Google doesn’t. <b>Made by students, for students.</b></div>
